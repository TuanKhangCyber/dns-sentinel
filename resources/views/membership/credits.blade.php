...
<section class="platform-hero">
    <p class="eyebrow">{{ strtoupper(__('platform.credit_wallet')) }}</p><h1>{{ __('platform.credits') }}</h1><p>{{ __('platform.credit_policy_short') }}</p>
</section>
...
<section class="platform-card">
    <header class="card-heading"><div><p class="eyebrow">{{ strtoupper(__('platform.ledger')) }}</p><h2>{{ __('platform.credits') }}</h2></div></header>
