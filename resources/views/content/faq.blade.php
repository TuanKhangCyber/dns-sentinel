...
<form method="GET" class="filter-row"><input name="q" value="{{ request('q') }}" placeholder="{{ __('platform.search_faq') }}" aria-label="{{ __('platform.search_faq') }}"><input name="category" value="{{ request('category') }}" placeholder="{{ __('platform.category') }}" aria-label="{{ __('platform.category') }}"><button>{{ __('platform.search') }}</button></form>
